...
Aqui encontra a descrição da infraestrutura computacional da UAlg, disponível para as aulas prática. São também indicados os programas que deverá instalar se preferir trabalhar no seu computador, na sala ou em casa.
...
Da página da Tutoria descarregue o ficheiro *T1.ipynb* para a sua área.
